...
<body id="body">
    ...
    <div class="flex flex-1 pt-16">
        @if (!in_array(Route::currentRouteName(), $authViews))
            ...
            <!-- Mobile Sidebar -->
            <aside class="fixed top-0 left-0 w-64 bg-white shadow-md p-6 h-full z-40 transform transition-transform duration-300 ease-in-out md:hidden" 
                x-show="sidebarOpen" 
                ...
                <ul class="space-y-4">
                    @admin
                        ...
                        <li><a href="{{ route('admin.dashboard') }}" class="sidebar-link-mobile">Dashboard</a></li>
                        <li><a href="{{ route('admin.table-of-graduates') }}" class="sidebar-link-mobile">Table of Graduates</a></li>
                        <li><a href="{{ route('admin.via-google-sheets') }}" class="sidebar-link-mobile">Google Sheets Data</a></li>
                        <li><a href="{{ route('admin.job-vacancies') }}" class="sidebar-link-mobile">Job Vacancies</a></li>
                    @endadmin
                    @user
                        <li><a href="{{ route('dashboard') }}" class="sidebar-link-mobile">Dashboard</a></li>
                        <li><a href="{{ route('table-of-graduates') }}" class="sidebar-link-mobile">View records</a></li>
                        <li><a href="{{ route('job-vacancies') }}" class="sidebar-link-mobile">Job Vacancies</a></li>
                    @enduser
                    @guest
                        <li><a href="{{ route('dashboard') }}" class="sidebar-link-mobile">Dashboard</a></li>
                        <li><a href="{{ route('table-of-graduates') }}" class="sidebar-link-mobile">View records</a></li>
        ...
        @endif
        <!-- Main -->
        <main class="flex-1 overflow-y-auto p-6 ml-20 h-[calc(100vh-4rem)] transition-all duration-300">
            <header class="mb-10">
                @if (session('success'))
