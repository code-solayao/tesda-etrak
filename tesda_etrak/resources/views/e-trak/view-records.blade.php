    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 text-end pt-3">
                <a href="{{ route('create-record-page') }}" class="btn btn-primary btn-lg" role="button">
                ...
                <button class="btn btn-danger btn-lg" type="button" data-bs-toggle="modal" data-bs-target="#deleteAllRecordsModal">
