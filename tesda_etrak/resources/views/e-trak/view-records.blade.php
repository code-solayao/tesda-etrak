        ...
        <div class="row">
            ...
            <div class="col-6 text-end pt-2">
                <form action="" method="GET">
                    <input type="text" class="form-control w-50 d-inline" name="search" value="" placeholder="Search record..." />
                    <input type="submit" class="btn btn-secondary" value="Search" />
                </form>
                <a href="{{ route('create-record-page') }}" class="btn btn-primary btn-lg mt-2" role="button">
                ...
                <button class="btn btn-danger btn-lg mt-2" type="button" data-bs-toggle="modal" data-bs-target="#deleteAllRecordsModal">
